...
This proposal paper is required for all students in the *project* sections of the Capstone (CS1980, CS1981, or BIOSC 1640/26860)

It is not required for students in the internship or research sections (CS1900, CS1950, or BIOSC 1640/18653).

## FORMATTING REQUIREMENTS

The paper must be 5 - 8 pages in length, using a relatively standard font and point size (e.g., 12-point Times New Roman or Computer Modern).  Judicious use of charts, graphs, and/or illustrations is encouraged, especially if it helps me to udnerstand the .  Margins should be of standard size (1" or less).
